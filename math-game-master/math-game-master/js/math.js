...
stopButton.onclick = function() {
	...
	if (times.length > 0) {
		...
		resultString = "Media de tiempo: " + mean.toPrecision(4) + " sec";
		categoryString = getCategory(mean);
	} else {
		resultString = "No se registraron resultados. Presione la tecla Enter para enviar sus respuestas.";
		categoryString = "";
	}
...
var getAnswer = function() {
	...
	if (answer === correct) {
		...
		response.innerHTML = "Inténtalo otra vez";
	}
